...
public class BoardingPass {
    ...
    public void writeImage() throws IOException {
        File file = new File("src/com/BoardingPassGUI/BoardingPassOutput/BoardingPass" + flightNum + "-" + seat + ".png");
        ImageIO.write(boardingPass, "png", file);
    }
    private BufferedImage passType() throws IOException {
        if(type.toUpperCase().equals("B")) {
            boardingPass = ImageIO.read(new File(("src/com/BoardingPassGUI/Assets/BuisnessClass.jpg")));
        }
        else {
            boardingPass = ImageIO.read(new File(("src/com/BoardingPassGUI/Assets/EconomyClass.jpg")));
        }
